...
Color kPrimaryColor = const Color(0xFF5FBD45);
Color kPrimaryMediumShade = const Color.fromARGB(255, 204, 254, 175);
Color kPrimaryLighterShade = const Color.fromARGB(255, 218, 244, 212);
